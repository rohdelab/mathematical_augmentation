...
num_classes, img_size, po_train, rm_edge = dataset_config(args.dataset)
...
if __name__ == '__main__':
    ...
    if args.use_image_feature:
        result_file = os.path.join(results_dir, 'nsws_0_image.hdf5')
    else:
        if args.classifier == 'mlp':
            result_file = os.path.join(results_dir, 'nsws_0__{}.hdf5'.format(args.classifier))
        else:
            result_file = os.path.join(results_dir, 'nsws_0.hdf5')
